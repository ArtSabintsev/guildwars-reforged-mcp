...
- Parse Guild Wars Wiki game-update headings in the live extract shape
  (`Update - September 1, 2026`) so `gw1_game_updates` and Source Smoke no
  longer report zero sections.
...
- refresh skill index from Guild Wars Wiki (rev 2735066, sha 03f44a441117) (2f49eeb)

## [1.3.6] - 2026-07-20

### Changed

- survive wiki 403 block windows — fresh-runner retry, green skip, daily cron (46eb24b)
